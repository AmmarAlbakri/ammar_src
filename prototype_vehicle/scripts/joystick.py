...
class Joystick(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.UiComponents()
        # self.setWindowIcon(QIcon('/home/mete/catkin_ws/src/prototype_vehicle/joystick.png'))
    ...
    def clickme(self):
        velocity_publisher_sol = rospy.Publisher(
            '/sol_teker_joint_velocity_controller/command', Float64, queue_size=10)
        velocity_publisher_sag = rospy.Publisher(
            '/sag_teker_joint_velocity_controller/command', Float64, queue_size=10)
